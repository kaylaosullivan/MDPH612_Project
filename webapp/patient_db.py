...
# Create organ database containing organ name, contour colour and decsription
...
# Create patient-organ database linking organs to patient
...
def insert_to_database(cur):
    ...
    organ_list = [
            ...
            [3, "Parotid Glands","red","<b>Function:</b> The parotid gland is a the largest salivary gland and is located on either side of the mouth in front of the ears. It secretes saliva into the mouth to facilitate chewing and swallowing. <br><br><b>Potential Side Effects:</b><br>- Dry mouth <br>- Difficulty swallowing <br>- Oral discomfort <br>- Malnutrition (due to difficulty eating) <br>- Oral mucositis <br>- Changes in taste <br>- Increased oral infections"],
